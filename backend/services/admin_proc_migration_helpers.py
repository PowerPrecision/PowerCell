"""Process client↔process migration helpers and background task.

Extraído de `routes/admin_process_migration.py`.

NOTE: Do NOT name this module `admin_process_migration` — that collides with the
route module `routes.admin_process_migration`.
"""
