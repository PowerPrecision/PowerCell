...
def test_restore_api_modules_exist():
    ...
    # PACOTE 11 (Eixo 4) — restore_api_client.py acrescentado (POST
    # /clients/{id}/restore — fecha a assimetria do client_delete.py).
    expected = [
        "restore_api_client.py",
...
def test_restore_api_export_run_entrypoints():
    ...
    assert callable(restore_api_client.run_restore_client)
