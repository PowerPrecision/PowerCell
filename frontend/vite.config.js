  ...
  return {
    ...
    resolve: {
      alias: {
        ...
        // Forçar todas as imports de Radix UI para a versão top-level.
        // Previne TDZ errors causados por nested node_modules com versões
        // diferentes (ex: react-slot 1.2.3 vs 1.2.4 nas dependências de
        // react-select e react-progress). Sem alias, Rollup inclui ambas
        // as versões, criando React Contexts duplicados que não comunicam.
        ...Object.fromEntries([
          '@radix-ui/number',
          '@radix-ui/primitive',
          ...
          '@radix-ui/rect',
        ].map(pkg => [pkg, path.resolve(__dirname, `./node_modules/${pkg}`)])),
      },
      dedupe: [
