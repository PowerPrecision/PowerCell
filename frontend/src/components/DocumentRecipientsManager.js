...
const DocumentRecipientsManager = ({ token, user }) => {
  ...
  const availableVariables = [
    ...
    { name: "---", desc: "--- Variáveis Financeiras ---" },
    { name: "{CAPITAIS_PROPRIOS}", desc: "Capitais Próprios" },
    { name: "{VALOR_IMOVEL}", desc: "Valor do Imóvel" },
    { name: "{VALOR_FINANCIAMENTO}", desc: "Valor do Financiamento" },
    { name: "{PRAZO_FINANCIAMENTO}", desc: "Prazo do Financiamento" },
    { name: "{COMPRA_SOZINHO}", desc: "Compra Sozinho?" },
    { name: "---", desc: "--- Remetente ---" },
