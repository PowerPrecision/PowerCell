...
const notificationColors = {
  ...
  document_expiry_watchdog: "text-red-500 bg-red-50",
        ...
        >
          {unreadCount > 0 ? (
            <>
              ...
              <span className="absolute -top-1 -right-1 z-20 h-5 w-5 rounded-full bg-red-500 text-white text-xs flex items-center justify-center font-bold shadow-sm">
