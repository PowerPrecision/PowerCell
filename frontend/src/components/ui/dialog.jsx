...
/**
 * DialogContent with built-in accessibility.
 *
 * Always renders hidden title and description via DialogPrimitive
 ...
 *
 * @param {object} props
 * @param {string} [props.title] - Optional title for the hidden accessibility title.
 * @param {string} [props.description] - Optional description for the hidden accessibility description.
 */
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed left-[50%] top-[50%] z-[100] grid w-[calc(100%-2rem)] sm:w-full max-w-lg max-h-[90vh] overflow-y-auto translate-x-[-50%] translate-y-[-50%] gap-4 border bg-background p-4 sm:p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] sm:rounded-lg",
          className
        )}
        {...props}>
        {/* Hidden title to satisfy Radix accessibility requirement.
            Visible DialogPrimitive.Title in children will override this
        ...
        {/* Hidden description to satisfy Radix accessibility requirement.
            Visible DialogPrimitive.Description in children will override this
            because it appears later in the DOM. */}
        <VisuallyHidden.Root>
