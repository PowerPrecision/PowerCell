/**
 * FinanceSettingsPage — Central de Comando Financeiro
 *
 * Página dedicada à configuração do sistema financeiro, acessível APENAS
 * por utilizadores com role admin ou ceo.
 *
 * Secções:
 * a) Configuração de Honorários — Taxas padrão de Mediação Imobiliária (%),
 *    Intermediação de Crédito (%) e IVA (%).
 * b) Modelo de Distribuição — Dropdown/switch entre Individual Split e Pool Global.
 *
 * Todos os saves fazem PUT/POST para a coleção FinanceConfig no backend.
 *
...
const FinanceSettingsPage = () => {
  ...
  // --- Estado: Configuração de Honorários (Fase 2 — FinanceConfig) ---
  ...
  // --- Estado: Configuração do Dashboard (Legacy — % por área) ---
    ...
    return (
      <DashboardLayout>
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-muted-foreground mt-2">Apenas administradores e CEOs podem aceder a esta página.</p>
          <Button variant="outline" className="mt-4 gap-2" onClick={() => navigate("/financeiro")}>
  ...
  return (
    <DashboardLayout>
      <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Central de comando — configure honorários, taxas e modelo de distribuição
            </p>
          </div>
          <Badge variant="outline" className="w-fit gap-1.5 px-3 py-1.5 text-sm border-amber-300 bg-amber-50 text-amber-700">
        ...
        {/* Erro global */}
        {error && (
          <div className="flex items-center gap-2 p-4 rounded-lg border border-red-200 bg-red-50 text-sm text-red-700">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                >
                  <div className={`p-2 rounded-lg ${feeType === "percentage" ? "bg-purple-100" : "bg-gray-100"}`}>
                ...
                >
                  <div className={`p-2 rounded-lg ${feeType === "fixed" ? "bg-purple-100" : "bg-gray-100"}`}>
            ...
            <div className="rounded-xl border bg-muted/30 p-5 space-y-3">
              ...
              <div className="grid grid-cols-3 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-semibold text-base text-emerald-700">{formatCurrency(total)}</p>
                </div>
              </div>
            </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                <div className="flex items-center gap-3 w-full">
                  <div className={`p-2.5 rounded-lg ${distributionModel === "individual_split" ? "bg-purple-100" : "bg-gray-100"}`}>
                ...
                <div className="w-full mt-2 text-xs space-y-1">
                  <p className="flex items-center gap-1.5">
                    <span className={`w-1.5 h-1.5 rounded-full ${distributionModel === "individual_split" ? "bg-purple-500" : "bg-gray-300"}`} />
              ...
              >
                <div className="flex items-center gap-3 w-full">
                  <div className={`p-2.5 rounded-lg ${distributionModel === "global_pool" ? "bg-emerald-100" : "bg-gray-100"}`}>
            ...
            {distributionModel === "global_pool" && (
              <div className="flex items-start gap-2 p-4 rounded-lg border border-emerald-200 bg-emerald-50/50 text-sm text-emerald-700">
            ...
            {/* Guardar Distribuição (part of honorários save) */}
            <div className="flex items-center gap-3 pt-2">
              <Button
                onClick={handleSaveHonorarios}
                disabled={savingHonorarios || !defaultValue}
