...
class PowerCellAPITester:
    def __init__(self, base_url="https://undo-toast-ui.preview.emergentagent.com"):
    ...
    def test_cors_headers(self):
        ...
        headers = {
            'Origin': 'https://undo-toast-ui.preview.emergentagent.com',
...
def main():
    ...
    print(f"🌐 URL: https://undo-toast-ui.preview.emergentagent.com")
