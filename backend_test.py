...
class PowerCellAPITester:
    def __init__(self, base_url="https://form-template-fix-1.preview.emergentagent.com"):
    ...
    def test_cors_headers(self):
        ...
        headers = {
            'Origin': 'https://form-template-fix-1.preview.emergentagent.com',
...
def main():
    ...
    print(f"🌐 URL: https://form-template-fix-1.preview.emergentagent.com")
