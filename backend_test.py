...
class PowerCellAPITester:
    def __init__(self, base_url="https://workflow-builder-95.preview.emergentagent.com"):
    ...
    def test_cors_headers(self):
        ...
        headers = {
            'Origin': 'https://workflow-builder-95.preview.emergentagent.com',
...
def main():
    ...
    print(f"🌐 URL: https://workflow-builder-95.preview.emergentagent.com")
